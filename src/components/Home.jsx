      ...
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <button
              onClick={() =>
                setUiLanguage((l) => (l === "en" ? "ur" : l === "ur" ? "hi" : "en"))
              }
              style={{
                display: "flex",
                alignItems: "center",
            ...
            >
              {uiLanguage === "en" ? "اردو" : uiLanguage === "ur" ? "हिन्दी" : "English"}
            </button>
            <button
...
function BPTracker({ session, uiLanguage }) {
  ...
  const voiceLang = uiLanguage === "ur" ? "ur-PK" : uiLanguage === "hi" ? "hi-IN" : "en-US";
...
function AdviceModal({ reading, onClose, uiLanguage }) {
  ...
  const speakResult = () => {
    ...
    const langCode = uiLanguage === "ur" ? "ur-PK" : uiLanguage === "hi" ? "hi-IN" : "en-US";
    setSpeaking(true);
    speak(text, langCode);
